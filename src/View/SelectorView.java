...
public class SelectorView extends JPanel implements ListSelectionListener
{
    ...
    public  SelectorView(NXModel m) {
    	...
    	/* public void setDeviceChannelView(SelectorView dc)
    	 {
    				ListSelectionModel listSelectionModel =tableauModul.getSelectionModel();        
    		        listSelectionModel.addListSelectionListener(this);
    		        upDateDeviceView();
    	 }
		public void upDateDeviceView()
		{
			...
			NXDevice[] devices=this.getSelectedDevices();
			if(devices.length==1)
			{
